...
function CakeSuccessModal({ request, onTrackOrder }) {
  const goHome = () => {
  ...
  return (
    <div className="cake-success-overlay" role="presentation">
      <section
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="cake-success-title"
      >
        <div className="cake-success-intro">
          ...
          <h2 id="cake-success-title">Request Submitted Successfully</h2>
          <p className="cake-success-subtitle">Thank you for choosing Sweet Bakes!</p>
          <p className="cake-success-description">
            We&apos;ve received your custom cake request. Our team will review your customization
...
export default CakeSuccessModal
