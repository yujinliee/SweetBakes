...
function CakeCustomerForm({
  ...
  const errors = useMemo(() => {
    ...
    if (customerInfo.fulfillment === 'pickup') {
  ...
  return (
    <section className="cake-base-form cake-customer-form" aria-labelledby="customer-info-title">
      <div className="cake-form-heading">
        ...
        <p>Tell us how we can contact you and when you&apos;d like to receive your custom order.</p>
      </div>
      ...
      <form>
        ...
        <fieldset className="cake-option-group cake-customer-section">
          ...
          <p className="cake-option-description">Choose how you&apos;d like to receive your custom order.</p>
          <div
