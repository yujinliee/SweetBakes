...
function PackageReferenceUpload({ referenceImages, onReferenceImagesChange }) {
  ...
  return (
    <section className="cake-reference-upload" aria-labelledby="package-reference-image-title">
      <div className="cake-reference-upload-heading">
        <h3 id="package-reference-image-title">
          Reference Image <span className="cake-optional-label">Optional</span>
        </h3>
        <span>{referenceImages.length} / 3 uploaded</span>
      </div>
      <p className="package-reference-upload-copy">
        Upload reference photos for your party package.
      </p>
      <label
...
export default PackageReferenceUpload
