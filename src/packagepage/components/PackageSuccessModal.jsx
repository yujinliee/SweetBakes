...
function PackageSuccessModal({ request, onTrackOrder }) {
  const goHome = () => {
    ...
    <div className="cake-success-overlay" role="presentation">
      ...
      >
        <div className="cake-success-intro">
          ...
          <h2 id="package-success-title">Request Submitted Successfully</h2>
          <p className="cake-success-subtitle">Thank you for choosing Sweet Bakes!</p>
          <p className="cake-success-description">
            We&apos;ve received your party package request. Our team will review your customization
            details and send you a quotation once it&apos;s ready.
          </p>
        </div>
