...
begin
  ...
  if p_product_type not in ('cupcake', 'cupcakes', 'custom_cupcake', 'custom_cupcakes', 'custom_party_package') then
  ...
  v_request_type := case
    when p_product_type in ('cupcake', 'cupcakes', 'custom_cupcake', 'custom_cupcakes') then 'custom_cupcake'
    else 'custom_party_package'
  end;
  v_item_type := case
    when p_product_type in ('cupcake', 'cupcakes', 'custom_cupcake', 'custom_cupcakes') then 'cupcake'
    else 'party_package'
  end;
